"""Portable sans-serif font configuration for the sealed Figure 3 package."""
...
from publication_style import format_figure, layout_report, pdf_panel_letters, svg_panel_letters  # noqa: E402
...
def configure_sans(mpl, font_manager, package_root: Path | None = None) -> str:
    """Use bundled local fonts when present, otherwise a safe system fallback."""
    ...
    mpl.rcParams.update(
        {"font.family": "sans-serif", "font.sans-serif": [selected, *FONT_STACK]}
    )
    return selected
